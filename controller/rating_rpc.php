...
$voted=mysql_num_rows(mysqli_query("SELECT used_ips FROM $rating_dbname.$rating_tableName WHERE used_ips LIKE '%".$ip."%' AND id='".$id_sent."' "));
...
$newtotals = mysqli_query("SELECT total_votes, total_value, used_ips FROM $rating_dbname.$rating_tableName WHERE id='$id_sent' ")or die(" Error: ".mysql_error());
...
$new_back[] .= '<span class="thanks">Thanks!</span></p>';
