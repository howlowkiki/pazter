...
(function($) {
  ...
  $.fn.extend({
    ...
    twzipcode: function(options) {
      ...
      try {
        sel.county = ( o.countyName ) ? ( $('select[name=' + o.countyName + ']').length > 0 ? $('select[name=' + o.countyName + ']') : _.append('<select name="' + o.countyName + '[]" />').children('select:eq(0)') ) : _.append('<select id="zip_county" name="zip_county[]" />').children('select:eq(0)');
        sel.area = ( o.areaName ) ? ( $('select[name=' + o.areaName + ']').length > 0 ? $('select[name=' + o.areaName + ']') : _.append('<select name="' + o.areaName + '[]" />').children('select:eq(1)') ) : _.append('<select id="zip_area" name="zip_area[]" />').children('select:eq(1)');
        sel.zip  = ( o.zipName ) ? ( $('input[name=' + o.zipName + ']').length > 0 ? $('input[name=' + o.zipName + ']') : _.append('<input type="text" name="' + o.zipName + '[]" />').children('input:eq(0)') ) : _.append('<input type="text" id="zip_code" name="zip_code[]" class="login_text_zip" maxlength="5" />').children('input:eq(0)');
      }
      catch(e){}
